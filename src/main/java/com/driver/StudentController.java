...
public class StudentController {
    ...
    public ResponseEntity<String> addStudentTeacherPair(@RequestParam String teacher, @RequestParam String student){
    ...
    public ResponseEntity<List<String>> getStudentsByTeacherName(@PathVariable String teacher){
        ...
        students=studentService.findStudentsToTeacher(teacher);
    ...
    @DeleteMapping("/delete-teacher-by-name/{teacher}")
